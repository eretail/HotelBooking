...
public class BookingRestControllerTest {
    ...
    private List<Booking> bookmarkList = new ArrayList<>();

    @Autowired
    private BookingRepository bookmarkRepository;
    ...
    public void setup() throws Exception {
        ...
        this.bookmarkList.add(bookmarkRepository.save(new Booking(account, "test1" + userName, "A description")));
        this.bookmarkList.add(bookmarkRepository.save(new Booking(account, "test2" + userName, "A description")));
    }
    ...
    public void createBooking() throws Exception {
        String bookmarkJson = json(new Booking(
